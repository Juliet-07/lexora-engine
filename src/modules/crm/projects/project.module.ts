...
import {
  ...
  MandateEmployeeThreadReadSchema,
  Task,
  TaskSchema,
  TimeEntry,
  TimeEntrySchema,
  ...
  LitigationCaseMessageSchema,
  LitigationCaseDraft,
  LitigationCaseDraftSchema,
  LitigationDocumentEntry,
  LitigationDocumentEntrySchema,
  LitigationDeadlineRule,
  LitigationDeadlineRuleSchema,
  PortfolioRisk,
  PortfolioRiskSchema,
} from './schemas';
import {
...
@Module({
  imports: [
    MongooseModule.forFeature([
      ...
      {
        name: MandateEmployeeThreadRead.name,
        schema: MandateEmployeeThreadReadSchema,
      },
      { name: Task.name, schema: TaskSchema },
      { name: TimeEntry.name, schema: TimeEntrySchema },
      { name: RateCard.name, schema: RateCardSchema },
      { name: Ticket.name, schema: TicketSchema },
      { name: SlaSettings.name, schema: SlaSettingsSchema },
      ...
      { name: LitigationCaseMessage.name, schema: LitigationCaseMessageSchema },
      { name: LitigationCaseDraft.name, schema: LitigationCaseDraftSchema },
      {
        name: LitigationDocumentEntry.name,
        schema: LitigationDocumentEntrySchema,
      },
      {
        name: LitigationDeadlineRule.name,
        schema: LitigationDeadlineRuleSchema,
      },
